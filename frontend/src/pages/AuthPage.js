...
export const AuthPage = () => {
    ...
    const deploymentWarning = (() => {
        ...
        if (!isRemote)
            return '';
        if (missing)
            return 'Backend URL is not set. Configure Vercel env var VITE_API_BASE to your backend URL ending with /api.';
        if (localApi)
            return 'Backend URL points to localhost. Update Vercel env var VITE_API_BASE to your deployed backend URL ending with /api.';
        return '';
    })();
